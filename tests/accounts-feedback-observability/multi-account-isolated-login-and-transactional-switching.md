...
1. Open `http://localhost:59001/`, open **Settings**, and expand **Accounts**.
...
8. In a test project under `/workspace`, create a test thread while A is active. Record only its thread ID, cwd, route, visible message count, and last visible item ID.
