...
const zhCN: Record<string, string> = {
  ...
  'Failed to refresh account quota': '刷新账户额度失败',
  'Login': '登录',
  'Add account': '添加账户',
  'Re-authenticate': '重新登录',
  'Re-authenticate account': '重新登录账户',
  'Refresh quota': '刷新额度',
  'Refreshing…': '刷新中…',
  ...
  'No accounts yet. Add one from this panel.': '尚无账户，请从此面板添加。',
  'Signing in adds or refreshes an account without switching the active quota source.': '登录只会添加或刷新账户，不会切换当前额度来源。',
  'Expected account: {account}': '预期账户：{account}',
  'Account added. The active quota source did not change.': '账户已添加；当前额度来源未改变。',
  'Account sign-in refreshed without adding a duplicate.': '账户登录状态已刷新，未添加重复账户。',
  'Account switched. New requests use the selected account; the current project and conversation are unchanged.': '账户已切换；之后的新请求使用所选账户，当前项目和对话未改变。',
